...
if __name__ == "__main__":
    # print(random_algorithm("Rushhour6x6_1.csv", 1))
    # print(random_algorithm_exp("Rushhour6x6_1.csv", 99))
    # replay_game("Rushhour6x6_easy.csv", "fake_log.csv")
    # data_analysis(all_turns_game_1)
    pass